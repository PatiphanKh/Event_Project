...
<div class=" flex flex-col sm:flex-row justify-between items-center mx-4 mb-6 gap-4">
    <h2 class="text-3xl font-bold text-gray-800 flex items-center gap-2">
        <span>⭐</span> กิจกรรมที่เข้าร่วม
    </h2>
    <a href="/" class="bg-[#00D1FF] text-black py-2.5 px-6 rounded-xl font-bold hover:opacity-80 transition shadow-sm">
        กิจกรรมเพิ่มเติม
    </a>
</div>

<div class="mx-4 mt-4 min-h-screen">
    <?php if (empty($events)): ?>
